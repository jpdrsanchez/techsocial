<x-templates.dashboard title="Create Order | Techsocial">
    <div class="max-w-6xl">
        <div class="flex items-start justify-between gap-2 mb-20">
            <div>
                <h1 class="text-4xl font-bold mb-2">New Order</h1>
        ...
        <form class="relative bg-white p-10 rounded-md shadow-sm" method="post" action="{{ route('web.dashboard.orders.store') }}">
            @method('POST')
            @csrf
            <div class="relative">
                <label
