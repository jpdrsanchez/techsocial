<x-templates.dashboard title="Edit Customer | Techsocial">
    <div class="max-w-6xl">
        ...
        <form class="relative bg-white p-10 rounded-md shadow-sm" method="post" action="{{ route('web.dashboard.customers.update', ['customer' => $customer]) }}">
            @method('PUT')
            @csrf
            <div class="relative">
                <label
